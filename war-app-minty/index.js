...
//let one_card = new Card("Spade", "10",10);
//console.log("Suit of our card is: " + one_card.suit);
...
//let whatever = createDeck();
//shuffledDeck(whatever);
...
//console.log("First Player Deck length: ", board.firstPlayer.deck);
for (let i = 26; i < 52; i++) { // adds deck to players hands
    //board.firstPlayer.deck.push(deck.pop(i));
    board.secondPlayer.deck.push(deck.pop()); 
}
//console.log("Second Player Deck length: ", board.secondPlayer.deck);
